(function() {
	...
	$.require($.path + '$.openid-conf.js', $.path + '$.app.js',
	function () {
		...
		function openidConfResponse() {
			$.app.publish('openid-conf-response', providers);
		}
		
		$.app.subscribe('openid-conf-request', openidConfResponse);
